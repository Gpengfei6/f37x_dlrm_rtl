...
- Estimate resources; do not connect HBM.

## Later gates

- Complete simplified-DLRM architecture review.
- Vitis RTL Kernel/AXI/HBM/F37X integration after GATE-4 approval.
- Duplicate-ID, HBM balance, and dynamic micro-batch research after foundations.
