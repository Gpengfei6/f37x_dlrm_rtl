#!/usr/bin/env python3
"""Compare expected A18.2 Host ELF SHA, on-disk ELF SHA, and build-record SHA.
...
def main():
    ...
    require("A18_2_HOST_XRT_BUILD=PASS" in status_text, "build status is not PASS")
    ...
    print("A18_2_HOST_ELF_IDENTITY=PASS")
...
if __name__ == "__main__":
    try:
        ...
        print("A18_2_HOST_ELF_IDENTITY=FAIL", file=sys.stderr)
