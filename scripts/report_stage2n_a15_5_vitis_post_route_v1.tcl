# Read-only routed-design reporting for a user-executed A15.5 Vitis link.
# Required environment variables: A15_5_ROUTED_DCP and A15_5_REPORT_DIR.

proc fail {message} {
    error $message
}

foreach required_env {A15_5_ROUTED_DCP A15_5_REPORT_DIR} {
    if {![info exists ::env($required_env)] || $::env($required_env) eq ""} {
        fail "Missing required environment variable: $required_env"
    }
}
set dcp_path [file normalize $::env(A15_5_ROUTED_DCP)]
set report_dir [file normalize $::env(A15_5_REPORT_DIR)]
...
puts $metrics "A15_5_VITIS_POST_ROUTE_REPORT=COMPLETE"
...
puts "A15_5_VITIS_POST_ROUTE_REPORT=COMPLETE"
