#!/usr/bin/env bash
#
# Build and validate the Stage 2N-A11 real-model automatic-pipeline asset v1.
#
...
BUILDER="${REPO_ROOT}/python/build_stage2n_a11_pipeline_batch_asset_v1.py"

BUILD_DIR="${REPO_ROOT}/build/stage2n_a11/assets_v1"
RESULT_DIR="${REPO_ROOT}/results/stage2n_a11/assets_v1"
EVIDENCE_DIR="${REPO_ROOT}/docs/evidence/stage2n_a11_assets_v1"

OUTPUT_ASSET="${BUILD_DIR}/stage2n_a11_real_model_batch_v1.f37xpb"
OUTPUT_MANIFEST="${RESULT_DIR}/stage2n_a11_real_model_batch_v1_manifest.json"
OUTPUT_CSV="${RESULT_DIR}/stage2n_a11_real_model_batch_v1_samples.csv"
STATUS="${RESULT_DIR}/stage2n_a11_real_model_batch_v1_status.txt"
...
fail()
{
    ...
    mkdir -p "${RESULT_DIR}"
    cat > "${STATUS}" <<EOF
STAGE2N_A11_PIPELINE_BATCH_ASSET_V1_FAILED
REASON=${reason}
NO_FPGA_ACCESS=1
...
require_exact "${STATUS}" "STAGE2N_A11_PIPELINE_BATCH_ASSET_V1_PASS"
...
(
    cd "${EVIDENCE_DIR}"
    sha256sum \
        stage2n_a11_real_model_batch_v1_status.txt \
        stage2n_a11_real_model_batch_v1_manifest.json \
        stage2n_a11_real_model_batch_v1_samples.csv \
        > stage2n_a11_pipeline_batch_asset_v1_manifest.sha256
)

echo "============================================================"
echo "STAGE2N_A11_PIPELINE_BATCH_ASSET_V1_PASS"
