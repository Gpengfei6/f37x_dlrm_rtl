#!/usr/bin/env bash
#
# Collect and validate final Stage 2N-A10 evidence (v2).
#
...
EVIDENCE_DIR="${REPO_ROOT}/docs/evidence/stage2n_a10_final_v1"
FINAL_STATUS="${EVIDENCE_DIR}/stage2n_a10_final_acceptance_v2_status.txt"
MANIFEST="${EVIDENCE_DIR}/stage2n_a10_final_evidence_manifest_v2.sha256"
...
STAGE2N_A10_FINAL_ACCEPTANCE_V2_FAILED
REASON=${reason}
NO_FPGA_ACCESS=1
...
cat > "${FINAL_STATUS}" <<EOF
STAGE2N_A10_FINAL_ACCEPTANCE_V2_PASS
...
echo "============================================================"
echo "STAGE2N_A10_FINAL_ACCEPTANCE_V2_PASS"
