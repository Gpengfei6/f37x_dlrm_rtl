`timescale 1ns/1ps
// A18.8: A18.6 T=8 mapped lookup with one A18.7 line cache per bank.
// Does not instantiate A13 or the boarded A18 public kernel.
module dlrm_hbm_t8_cached_lookup_stage2n_a18_8_v1 #(
