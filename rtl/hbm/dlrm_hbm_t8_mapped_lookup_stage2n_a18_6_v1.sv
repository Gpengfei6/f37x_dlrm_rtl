`timescale 1ns/1ps
// A18.6 kernel-side T=8 lookup through four accepted A14 v2 engines.
// Instantiates the A18.5 table-to-bank mapper. Does not modify the boarded
// A18 public kernel and does not feed eight embeddings into frozen A13.
module dlrm_hbm_t8_mapped_lookup_stage2n_a18_6_v1 #(
