...
module dlrm_f37x_rtl_kernel_stage2n_a18_v1 #(
    ...
    output logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem0_awid,
    output logic [C_M_AXI_GMEM_ADDR_WIDTH-1:0] m_axi_gmem0_awaddr,
    output logic [7:0]                         m_axi_gmem0_awlen,
    output logic [2:0]                         m_axi_gmem0_awsize,
    output logic [1:0]                         m_axi_gmem0_awburst,
    output logic                               m_axi_gmem0_awlock,
    ...
    output logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem0_wdata,
    ...
    input  logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem0_rid,
    input  logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem0_rdata,
    ...
    output logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem1_awid,
    output logic [C_M_AXI_GMEM_ADDR_WIDTH-1:0] m_axi_gmem1_awaddr,
    output logic [7:0]                         m_axi_gmem1_awlen,
    output logic [2:0]                         m_axi_gmem1_awsize,
    output logic [1:0]                         m_axi_gmem1_awburst,
    output logic                               m_axi_gmem1_awlock,
    ...
    output logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem1_wdata,
    output logic [(C_M_AXI_GMEM_DATA_WIDTH/8)-1:0]
                                                 m_axi_gmem1_wstrb,
    ...
    input  logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem1_rid,
    input  logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem1_rdata,
    ...
    output logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem2_awid,
    output logic [C_M_AXI_GMEM_ADDR_WIDTH-1:0] m_axi_gmem2_awaddr,
    output logic [7:0]                         m_axi_gmem2_awlen,
    output logic [2:0]                         m_axi_gmem2_awsize,
    output logic [1:0]                         m_axi_gmem2_awburst,
    output logic                               m_axi_gmem2_awlock,
    ...
    output logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem2_wdata,
    output logic [(C_M_AXI_GMEM_DATA_WIDTH/8)-1:0]
                                                 m_axi_gmem2_wstrb,
    ...
    input  logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem2_rid,
    input  logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem2_rdata,
    ...
    output logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem3_awid,
    output logic [C_M_AXI_GMEM_ADDR_WIDTH-1:0] m_axi_gmem3_awaddr,
    output logic [7:0]                         m_axi_gmem3_awlen,
    output logic [2:0]                         m_axi_gmem3_awsize,
    output logic [1:0]                         m_axi_gmem3_awburst,
    output logic                               m_axi_gmem3_awlock,
    ...
    output logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem3_wdata,
    output logic [(C_M_AXI_GMEM_DATA_WIDTH/8)-1:0]
                                                 m_axi_gmem3_wstrb,
    ...
    input  logic [C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem3_rid,
    input  logic [C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem3_rdata,
    ...
    // Packed internal read channels map one-to-one onto the four explicit
    // public AXI masters. Index 0 supplies embedding slot 0, and so on.
    logic [3:0][C_M_AXI_GMEM_ID_WIDTH-1:0]   gmem_arid;
    logic [3:0][C_M_AXI_GMEM_ADDR_WIDTH-1:0] gmem_araddr;
    logic [3:0][7:0]                         gmem_arlen;
    logic [3:0][2:0]                         gmem_arsize;
    logic [3:0][1:0]                         gmem_arburst;
    logic [3:0]                              gmem_arlock;
    logic [3:0][3:0]                         gmem_arcache;
    logic [3:0][2:0]                         gmem_arprot;
    logic [3:0][3:0]                         gmem_arqos;
    logic [3:0]                              gmem_arvalid;
    logic [3:0]                              gmem_arready;
    logic [3:0][C_M_AXI_GMEM_ID_WIDTH-1:0]   gmem_rid;
    logic [3:0][C_M_AXI_GMEM_DATA_WIDTH-1:0] gmem_rdata;
    logic [3:0][1:0]                         gmem_rresp;
    logic [3:0]                              gmem_rlast;
    logic [3:0]                              gmem_rvalid;
    logic [3:0]                              gmem_rready;
    ...
    assign m_axi_gmem0_awsize = 3'd4;
    assign m_axi_gmem0_awburst = 2'b01;
    assign m_axi_gmem0_awlock = 1'b0;
    ...
    assign m_axi_gmem1_awsize = 3'd4;
    assign m_axi_gmem1_awburst = 2'b01;
    assign m_axi_gmem1_awlock = 1'b0;
    ...
    assign m_axi_gmem2_awsize = 3'd4;
    assign m_axi_gmem2_awburst = 2'b01;
    assign m_axi_gmem2_awlock = 1'b0;
    ...
    assign m_axi_gmem3_awaddr = '0;
    assign m_axi_gmem3_awlen = 8'd0;
    assign m_axi_gmem3_awsize = 3'd4;
    assign m_axi_gmem3_awburst = 2'b01;
    assign m_axi_gmem3_awlock = 1'b0;
    ...
    assign m_axi_gmem3_wdata = '0;
    assign m_axi_gmem3_wstrb = '0;
    assign m_axi_gmem3_wlast = 1'b0;
    assign m_axi_gmem3_wvalid = 1'b0;
    assign m_axi_gmem3_bready = 1'b0;

    assign m_axi_gmem0_arid = gmem_arid[0];
    assign m_axi_gmem0_araddr = gmem_araddr[0];
    assign m_axi_gmem0_arlen = gmem_arlen[0];
    assign m_axi_gmem0_arsize = gmem_arsize[0];
    assign m_axi_gmem0_arburst = gmem_arburst[0];
    assign m_axi_gmem0_arlock = gmem_arlock[0];
    assign m_axi_gmem0_arcache = gmem_arcache[0];
    assign m_axi_gmem0_arprot = gmem_arprot[0];
    assign m_axi_gmem0_arqos = gmem_arqos[0];
    assign m_axi_gmem0_arvalid = gmem_arvalid[0];
    assign gmem_arready[0] = m_axi_gmem0_arready;
    assign gmem_rid[0] = m_axi_gmem0_rid;
    assign gmem_rdata[0] = m_axi_gmem0_rdata;
    assign gmem_rresp[0] = m_axi_gmem0_rresp;
    assign gmem_rlast[0] = m_axi_gmem0_rlast;
    assign gmem_rvalid[0] = m_axi_gmem0_rvalid;
    assign m_axi_gmem0_rready = gmem_rready[0];

    assign m_axi_gmem1_arid = gmem_arid[1];
    assign m_axi_gmem1_araddr = gmem_araddr[1];
    assign m_axi_gmem1_arlen = gmem_arlen[1];
    assign m_axi_gmem1_arsize = gmem_arsize[1];
    assign m_axi_gmem1_arburst = gmem_arburst[1];
    assign m_axi_gmem1_arlock = gmem_arlock[1];
    assign m_axi_gmem1_arcache = gmem_arcache[1];
    assign m_axi_gmem1_arprot = gmem_arprot[1];
    assign m_axi_gmem1_arqos = gmem_arqos[1];
    assign m_axi_gmem1_arvalid = gmem_arvalid[1];
    assign gmem_arready[1] = m_axi_gmem1_arready;
    assign gmem_rid[1] = m_axi_gmem1_rid;
    assign gmem_rdata[1] = m_axi_gmem1_rdata;
    assign gmem_rresp[1] = m_axi_gmem1_rresp;
    assign gmem_rlast[1] = m_axi_gmem1_rlast;
    assign gmem_rvalid[1] = m_axi_gmem1_rvalid;
    assign m_axi_gmem1_rready = gmem_rready[1];

    assign m_axi_gmem2_arid = gmem_arid[2];
    assign m_axi_gmem2_araddr = gmem_araddr[2];
    assign m_axi_gmem2_arlen = gmem_arlen[2];
    assign m_axi_gmem2_arsize = gmem_arsize[2];
    assign m_axi_gmem2_arburst = gmem_arburst[2];
    assign m_axi_gmem2_arlock = gmem_arlock[2];
    assign m_axi_gmem2_arcache = gmem_arcache[2];
    assign m_axi_gmem2_arprot = gmem_arprot[2];
    assign m_axi_gmem2_arqos = gmem_arqos[2];
    assign m_axi_gmem2_arvalid = gmem_arvalid[2];
    assign gmem_arready[2] = m_axi_gmem2_arready;
    assign gmem_rid[2] = m_axi_gmem2_rid;
    assign gmem_rdata[2] = m_axi_gmem2_rdata;
    assign gmem_rresp[2] = m_axi_gmem2_rresp;
    assign gmem_rlast[2] = m_axi_gmem2_rlast;
    assign gmem_rvalid[2] = m_axi_gmem2_rvalid;
    assign m_axi_gmem2_rready = gmem_rready[2];

    assign m_axi_gmem3_arid = gmem_arid[3];
    assign m_axi_gmem3_araddr = gmem_araddr[3];
    assign m_axi_gmem3_arlen = gmem_arlen[3];
    assign m_axi_gmem3_arsize = gmem_arsize[3];
    assign m_axi_gmem3_arburst = gmem_arburst[3];
    assign m_axi_gmem3_arlock = gmem_arlock[3];
    assign m_axi_gmem3_arcache = gmem_arcache[3];
    assign m_axi_gmem3_arprot = gmem_arprot[3];
    assign m_axi_gmem3_arqos = gmem_arqos[3];
    assign m_axi_gmem3_arvalid = gmem_arvalid[3];
    assign gmem_arready[3] = m_axi_gmem3_arready;
    assign gmem_rid[3] = m_axi_gmem3_rid;
    assign gmem_rdata[3] = m_axi_gmem3_rdata;
    assign gmem_rresp[3] = m_axi_gmem3_rresp;
    assign gmem_rlast[3] = m_axi_gmem3_rlast;
    assign gmem_rvalid[3] = m_axi_gmem3_rvalid;
    assign m_axi_gmem3_rready = gmem_rready[3];
...
// Stage 2N-A17.2 AXI-Lite adapter for the four-port all-HBM pipeline.
//
// The complete accepted A13 window through 0x224 and the accepted A15 window
// through 0x310 are preserved. A17.2 adds three further 64-bit table bases at
// 0x318-0x32C while leaving 0x314 reserved.
module dlrm_internal_pipeline_axi_lite_adapter_stage2n_a18_v1 #(
    parameter integer C_S_AXI_CONTROL_ADDR_WIDTH = 12,
    parameter integer C_S_AXI_CONTROL_DATA_WIDTH = 32,
    parameter integer C_M_AXI_GMEM_ADDR_WIDTH = 64,
    parameter integer C_M_AXI_GMEM_DATA_WIDTH = 128,
    ...
    output logic [3:0][C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem_arid,
    output logic [3:0][C_M_AXI_GMEM_ADDR_WIDTH-1:0] m_axi_gmem_araddr,
    output logic [3:0][7:0]                         m_axi_gmem_arlen,
    output logic [3:0][2:0]                         m_axi_gmem_arsize,
    output logic [3:0][1:0]                         m_axi_gmem_arburst,
    output logic [3:0]                              m_axi_gmem_arlock,
    output logic [3:0][3:0]                         m_axi_gmem_arcache,
    output logic [3:0][2:0]                         m_axi_gmem_arprot,
    output logic [3:0][3:0]                         m_axi_gmem_arqos,
    output logic [3:0]                              m_axi_gmem_arvalid,
    input  logic [3:0]                              m_axi_gmem_arready,

    input  logic [3:0][C_M_AXI_GMEM_ID_WIDTH-1:0]   m_axi_gmem_rid,
    input  logic [3:0][C_M_AXI_GMEM_DATA_WIDTH-1:0] m_axi_gmem_rdata,
    input  logic [3:0][1:0]                         m_axi_gmem_rresp,
    input  logic [3:0]                              m_axi_gmem_rlast,
    input  logic [3:0]                              m_axi_gmem_rvalid,
    output logic [3:0]                              m_axi_gmem_rready
);
    ...
    logic [3:0][C_M_AXI_GMEM_ADDR_WIDTH-1:0] a17_table_base_stage;
    logic [3:0][C_M_AXI_GMEM_ADDR_WIDTH-1:0] a17_table_base_cmd;
    ...
    // A17.2 retains the A16.1 inclusive event contract:
    ...
    // - lookup ends when the accepted A17.1 group reports that slot 3 has
    ...
    // Kernel-level command sequencer. It snapshots all four staging bases on
    // the accepted START edge; the A17.1 and A13 state machines own lookup,
    // injection and inference details after that point.
    always_ff @(posedge ap_clk) begin
        if (!ap_rst_n) begin
            a15_state <= A15_IDLE;
            a17_table_base_cmd <= '0;
            ...
            case (a15_state)
                A15_IDLE: begin
                    if (write_fire &&
                        ...
                        a17_table_base_cmd <= a17_table_base_stage;
                ...
                case (awaddr_reg)
                    ...
                    ADDR_A15_TABLE_BASE_LO: begin
                        if (a15_state != A15_IDLE) begin
                            ...
                            a17_table_base_stage[0][31:0] <= apply_wstrb32(
                                a17_table_base_stage[0][31:0],
                                wdata_reg, wstrb_reg);
                        end
                    end
                    ...
                    ADDR_A15_TABLE_BASE_HI: begin
                        if (a15_state != A15_IDLE) begin
                            ...
                            a17_table_base_stage[0][63:32] <= apply_wstrb32(
                                a17_table_base_stage[0][63:32],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE1_LO: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
                            a17_table_base_stage[1][31:0] <= apply_wstrb32(
                                a17_table_base_stage[1][31:0],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE1_HI: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
                            a17_table_base_stage[1][63:32] <= apply_wstrb32(
                                a17_table_base_stage[1][63:32],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE2_LO: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
                            a17_table_base_stage[2][31:0] <= apply_wstrb32(
                                a17_table_base_stage[2][31:0],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE2_HI: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
                            a17_table_base_stage[2][63:32] <= apply_wstrb32(
                                a17_table_base_stage[2][63:32],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE3_LO: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
                            a17_table_base_stage[3][31:0] <= apply_wstrb32(
                                a17_table_base_stage[3][31:0],
                                wdata_reg, wstrb_reg);
                        end
                    end

                    ADDR_A17_TABLE_BASE3_HI: begin
                        if (a15_state != A15_IDLE) begin
                            wrapper_error_latched <= 1'b1;
                            wrapper_error_code <= WRAPPER_ERROR_PENDING;
                        end else begin
        ...
        if (!ap_rst_n) begin
            ...
            if (ar_fire) begin
                case (s_axi_control_araddr)
                    ...
                    ADDR_PIPE_VERSION:
                        s_axi_control_rdata <= 32'h0002_4E18;
                    ...
                    ADDR_A15_TABLE_BASE_LO:
                        s_axi_control_rdata <= a17_table_base_stage[0][31:0];
                    ADDR_A15_TABLE_BASE_HI:
                        s_axi_control_rdata <= a17_table_base_stage[0][63:32];
                    ...
                    ADDR_A17_RESERVED:
                        s_axi_control_rdata <= 32'd0;
                    ADDR_A17_TABLE_BASE1_LO:
                        s_axi_control_rdata <= a17_table_base_stage[1][31:0];
                    ADDR_A17_TABLE_BASE1_HI:
                        s_axi_control_rdata <= a17_table_base_stage[1][63:32];
                    ADDR_A17_TABLE_BASE2_LO:
                        s_axi_control_rdata <= a17_table_base_stage[2][31:0];
                    ADDR_A17_TABLE_BASE2_HI:
                        s_axi_control_rdata <= a17_table_base_stage[2][63:32];
                    ADDR_A17_TABLE_BASE3_LO:
                        s_axi_control_rdata <= a17_table_base_stage[3][31:0];
                    ADDR_A17_TABLE_BASE3_HI:
    ...
    dlrm_hbm_pipeline_integration_stage2n_a18_v1 #(
        ...
        .table_base_addr(a17_table_base_cmd),
