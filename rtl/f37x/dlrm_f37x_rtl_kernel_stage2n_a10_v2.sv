...
// Stage 2N-A10 v2 capacity-expanded integration top.
//
...
//
// The capacity-expanded internal-pipeline AXI-Lite adapter remains at 0x180-0x217. One START
// command in that window launches Bottom MLP -> Interaction -> Top MLP.
module dlrm_f37x_rtl_kernel_stage2n_a10_v2 #(
