...
//
// A new internal-pipeline AXI-Lite adapter is added at 0x180-0x217. One START
// command in that window launches Bottom MLP -> Interaction -> Top MLP.
module dlrm_f37x_rtl_kernel_stage2n_a7 #(
    ...
    dlrm_internal_pipeline_axi_lite_adapter_stage2n_a7
        u_pipeline_adapter (
        .ap_clk(ap_clk),
        .ap_rst_n(ap_rst_n),
